...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index2.php">DAFTAR MAHASISWA | BARU</a>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-person-plus-fill"></i>&nbsp;MASUKAN DATA DIRI ANDA</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            <div class="col-md-6 my-2">
                ...
                <p>untuk kenyamanan dan keamanan web di mohon untuk admin sering untuk melakukan manajemen pada aplikasi yang sudah teresedia memperbaiki syntak dan memperbaiki data yang telah ada</p>
            </div>
    ...
    <footer class="bg-dark text-white text-center" style="padding: 5px;">
        <p>Created with <i class="bi bi-suit-heart-fill" style="color: red;"></i> by <a href="" target="_blank" style="color: #fff;">christian</a></p>
    </footer>
    <!-- Close Footer -->
